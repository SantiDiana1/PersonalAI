...
- **Infraestructura**: un servidor local (hoy WSL2/Docker Desktop del Operador; destino planeado, un Mac Mini dedicado) con Docker. Se descarta un VPS por coste — ver [docs/architecture.md §Despliegue](docs/architecture.md#despliegue) para el razonamiento y las implicaciones de seguridad/disponibilidad.
