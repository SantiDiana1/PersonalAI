...
- **Infraestructura**: un servidor local (Mac Mini del Operador) con Docker. Se descarta un VPS por coste — ver [docs/architecture.md §Despliegue](docs/architecture.md#despliegue) para el razonamiento y las implicaciones de seguridad/disponibilidad.
