...
- **Corrección aplicada** (confirmada con el Operador, ver conversación): `hermes-claude-auth` pasa de ser "un volumen Docker con `~/.claude/` montado read-only" a ser "un secreto (el valor del token), guardado en `.env` fuera de git, inyectado como `CLAUDE_CODE_OAUTH_TOKEN`". Aplicado a `docs/hermes/spec.md` §0.1/§0.3/§3.1/§3.2/§3.4/§6/§8 y a `docs/decisions-log.md` US-0.4.
